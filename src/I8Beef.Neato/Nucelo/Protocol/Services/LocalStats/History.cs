...
namespace I8Beef.Neato.Nucelo.Protocol.Services.LocalStats
{
    /// <summary>
    /// History.
    /// </summary>
    ...
    {
        /// <summary>
        /// The ISO8601 formatted GMT date & time stating when the cleaning event started.
        /// </summary>
        [JsonProperty(PropertyName = "start")]
        public DateTime Start { get; set; }

        /// <summary>
        /// The ISO8601 formatted GMT date & time stating when the cleaning event ended..
        /// </summary>
